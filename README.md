...
- **GitHub Discussions** — [Open a Q&A discussion](https://github.com/sanidhyy/evently/discussions/new?category=q-a) for setup and troubleshooting help.
...
- [@stripe/stripe-js](https://www.npmjs.com/package/@stripe/stripe-js): ^2.4.0
